...
test_that("Numeric & positive", { 
  ...
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "wosa", lag.prewhite = 0)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "wosa", lag.prewhite = 1)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "wosa", lag.prewhite = NULL)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "bartlett", lag.prewhite = 0)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "bartlett", lag.prewhite = 1)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "bartlett", lag.prewhite = NULL)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "tukey", lag.prewhite = 0)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "tukey", lag.prewhite = 1)
  expect_true(is.numeric(out) && out > 0)
  out = nse.spec0(x = x, type = "tukey", lag.prewhite = NULL)
  expect_true(is.numeric(out) && out > 0)
